...
from app.services.account_pool import acquire, get_session_credentials
...
async def run_match_core(session_factory: async_sessionmaker, task_id: int, *, embedder,
    ...
    while True:
        ...
        try:
            ...
            # 商品级失败：记录日志并置 failed，保留已提交的 cursor/stats 供人工排查后续跑（spec §4.2.6）
