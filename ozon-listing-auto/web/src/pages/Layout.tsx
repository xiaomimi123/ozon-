    ...
    <AntLayout style={{ minHeight: "100vh" }}>
      <AntLayout.Sider>
        ...
        <Menu theme="dark" mode="inline" defaultSelectedKeys={["tasks"]}
          onClick={(e) => nav(`/${e.key}`)}
          items={[{ key: "tasks", label: "任务中心" }, { key: "products", label: "商品列表" }, { key: "review", label: "审核台" }, { key: "listing", label: "上架审核" }, { key: "shops", label: "店铺管理" }, { key: "pricing", label: "定价设置" }, { key: "monitor", label: "上架监控" }]} />
      </AntLayout.Sider>
      <AntLayout>
